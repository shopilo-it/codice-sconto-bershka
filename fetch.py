#!/usr/bin/env python3
"""
Recupero codici sconto Bershka da shopilo.it
Sursa: https://shopilo.it/negozi/bershka.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/bershka.com"
STORE_NAME = "Bershka"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Bershka da shopilo.it"""
    headers = {
